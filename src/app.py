...
activities = {
    ...
    "Music Band": {
        ...
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "lisa@mergington.edu"]
    },
    "Debate Team": {
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Find matching participant (case-insensitive, ignore surrounding whitespace)
    ...
    raise HTTPException(status_code=404, detail="Student not signed up for activity")
